...
class Example(wx.Frame):
    ...
    def InitUI(self):
        ...
        # stream = base64.b64encode(CCBFunction().get_check_code())
        # print(stream)
        # image = wx.Image(stream, wx.BITMAP_TYPE_PNG).Rescale(80, 25).ConvertToBitmap()
        image = wx.Image(r'D:\python space\phone_extract\tu.png', wx.BITMAP_TYPE_PNG).Rescale(80,
                                                                                 25).ConvertToBitmap()  # 获取图片，转化为Bitmap形式
